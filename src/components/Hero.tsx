      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8 inline-flex items-center bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 animate-fade-in-up border border-white/20">
            ...
            <span className="text-white text-sm font-medium">Trusted by 500+ SMEs</span>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up animation-delay-600">
            <button 
              ...
              className="group bg-[#ff3131] text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-[#e62929] transition-all duration-300 transform hover:scale-105 shadow-xl flex items-center"
            ...
            <button className="text-white border-2 border-white/50 backdrop-blur-sm px-8 py-4 rounded-lg font-semibold text-lg hover:bg-white hover:text-[#11166c] transition-all duration-300 hover:border-white">
              Learn More
            </button>
          </div>
          
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 text-center animate-fade-in-up animation-delay-800">
            {[
              ...
              <div key={index} className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-1">
                <div className="text-2xl md:text-3xl font-bold text-[#ff3131] mb-2">{stat.number}</div>
